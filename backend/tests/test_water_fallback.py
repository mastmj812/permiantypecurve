...
def test_bounds_apply_overridden_di_hi() -> None:
    (lower, upper), _p0 = _bounds_and_p0("modified_hyperbolic", 1000.0, di_hi=12.0)
...
def test_bound_badge_di_cap_is_per_stream() -> None:
    ...
    _, water_note = detect_at_bound(qi=500, di=8.0, b=1.0, peak_rate=1000, di_hi=12.0)
...
def test_bound_badge_note_reports_the_passed_cap() -> None:
    ...
    # oil-tuned "(4.0)".
    at_bound, note = detect_at_bound(qi=500, di=11.9, b=1.0, peak_rate=1000, di_hi=12.0)
